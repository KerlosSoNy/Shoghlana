...
export default function Page() {
    return (
        <div className='flex flex-col'>
                ...
                <div className="p-6 rounded-xl bg-white -mt-10 relative z-[10]">
                    ...
                    <div className="flex flex-row justify-between items-center mt-[31px]">
                        <div className='flex flex-row items-center'>
                            <button className="bg-main rounded-[5px] h-[40px] w-[200px] text-[15px] font-[400] text-white">
                                Apply For Job
                            </button>
                            ...
                            <div className='flex flex-row ms-10 divide-x-[1px] divide-black/40'>
                                ...
                                <div className="flex flex-col items-center  px-6">
                                    ...
                                    <span className="font-[400] text-[13px] text-[#4D6182]">In Consideration</span>
                                </div>
                                <div className="flex flex-col items-center  px-6">
                                    <span className="font-[600] text-[16px] text-[#4D6182]">0</span>
                                    <span className="font-[400] text-[13px] text-[#4D6182]">Not Selected</span>
                                </div>
                            </div>
                        </div>
            ...
            <div className='w-[80%] mx-auto mt-[36px]'>
                <JobDetails />
            </div>
            <div className='w-[80%] mx-auto mt-[36px]'>
                <JobRequirements />
