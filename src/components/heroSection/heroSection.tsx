...
export default function HeroSection() {
    return (
        <div className='mx-[8px] w-[calc(100%-16px)] rounded-[25px] relative h-[120vh] !bg-black/15 my-[10px] overflow-hidden'>
            <Background />
            <div className='flex flex-col items-center pt-[281px] text-white h-full'>
                ...
                <span className='w-[39%] text-[25px] mb-[163px] text-center'>
