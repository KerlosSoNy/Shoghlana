...
export default function SelfInformation({ handleNext }: { handleNext: () => void }) {
    return (
        <div className='w-[60%] bg-white relative z-[2] -mt-[80px] minh-[693px] shadow-2xl mb-20 mx-auto rounded-[25px] pb-[32px] ps-[25px] pt-[45px] flex flex-col items-start'>
            ...
            <div className='flex flex-col w-full ps-[15px] -mt-3 pe-[50px]'>
                <span className='font-medium text-[24px] text-black'>Your information</span>
                <div className='flex flex-row w-full mt-4 mb-[30px] gap-[32px]'>
            ...
            <div className='flex flex-col pt-[22px] mt-[26px] border-t-[1px] border-gray-200 border-dashed w-[calc(100%-50px)] ps-[15px]'>
                ...
                <div className='w-[70%] grid grid-cols-3 mt-3 items-center gap-5'>
            ...
            <div className='flex flex-row items-center w-full justify-center gap-4 mt-16'>
