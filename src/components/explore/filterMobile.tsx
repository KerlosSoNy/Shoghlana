...
export default function JobsFilterMobile() {
    ...
    const [isOpen, setIsOpen] = useState<boolean>(false); // State to control the mobile menu visibility
    ...
    return (
        <div className="relative">
            ...
            {isOpen && (
                <div ref={menuRef} className="absolute top-12 right-[-100%] md:right-[-110%] w-[100vw] md:w-[50vw] bg-white rounded-lg shadow-md z-10">
